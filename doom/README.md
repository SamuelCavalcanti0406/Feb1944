...
| Ação | Tecla / Controle |
|---|---|
| **Movimentação / Strafe** | `W`, `A`, `S`, `D` ou `Setas` |
| **Olhar / Rotacionar** | Mover o Mouse (ou `Q` / `E`) |
| **Disparar / Atacar** | `Botão Esquerdo do Mouse` |
| **Interagir / Portas / Segredos** | `E` ou `Barra de Espaço` |
| **Trocar de Armas** | `1`, `2`, `3`, `4` ou `Roda do Mouse` |
| **Ativar / Desativar Efeito CRT** | Botão inferior no rodapé |
